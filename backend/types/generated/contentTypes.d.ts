...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['HR', 'Legal', 'Talenta']>;
...
export interface ApiConsultationConsultation extends Struct.CollectionTypeSchema {
  collectionName: 'consultations';
  info: {
    description: 'Data pemesanan konsultasi dari website Dharma Banten';
    displayName: 'Jadwal Konsultasi';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::consultation.consultation'> &
      Schema.Attribute.Private;
    ...
    status: Schema.Attribute.Enumeration<['Baru', 'Dikonfirmasi', 'Selesai', 'Dibatalkan']> &
