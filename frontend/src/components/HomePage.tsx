...
import { fetchHeroFromStrapi } from '../services/strapi';
...
export function HomePage({
  ...
  return (
    ...
    >
      <SEO
        canonical="/"
        title="Konsultan Hukum, HR & Manajemen Talenta Terpadu"
        description="Dharma Banten menyediakan konsultasi hukum ketenagakerjaan, penataan human resources, manajemen kepemimpinan, dan kepatuhan regulasi korporasi di Tangerang dan sekitarnya."
      />
      <header role="banner" className={`landing-header ${scrolled ? 'is-scrolled' : ''} ${menuOpen ? 'is-menu-open' : ''}`}>
      ...
      <main id="main-content" className="snap-main-container">
        {/* Screen 01: Hero */}
        <section id="top" className="landing-hero section-snap-screen" aria-labelledby="hero-title">
          <img
            src={currentHeroImage}
            className="hero-photo"
            alt="Konsultan hukum dan SDM profesional Dharma Banten di ruang diskusi eksekutif"
            loading="eager"
            width="1920"
            height="1080"
          />
        ...
        >
          <div className="layout-wide section-screen-inner final-screen-inner">
            ...
            {/* Lower Footer Grid */}
            <footer className="final-footer-grid" role="contentinfo" aria-label="Informasi Footer Dharma Banten">
