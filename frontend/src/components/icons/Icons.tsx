...
export function DocumentIcon({ className = '', size = 24 }: { className?: string; size?: number }) {
  return <LuFileText className={className} size={size} aria-hidden="true" />;
}

export function BookOpenIcon({ className = '', size = 24 }: { className?: string; size?: number }) {
  return <LuBookOpen className={className} size={size} aria-hidden="true" />;
}

export function ResetIcon({ className = '', size = 16 }: { className?: string; size?: number }) {
  return <LuRotateCcw className={className} size={size} aria-hidden="true" />;
}
